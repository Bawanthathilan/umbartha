...
const HeroSection = ({
  ...
  return (
    <div className=" h-auto pt-36  lg:pt-0 md:pt-36 md:h-auto lg:h-[520px] w-full bg-hero-gradient px-5 z-10 ">
      <div
        className={`container relative z-10 mx-auto max-w-6xl flex w-full h-full flex-col items-left ${
          left ? "lg:items-start" : "lg:items-center"
        }  lg:justify-center md:justify-end justify-end gap-4`}
      >
