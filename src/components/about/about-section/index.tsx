                            ...
                            <div className="grid grid-cols-2 items-baseline gap-3 lg:gap-5">
                                <div className="itemOne flex flex-col gap-5">
                                    <div className="img relative h-[367px] lg:h-[587px] w-full">
                                        <Image src={Yoga} alt='yoga' fill className=' object-cover rounded-xl' />
                                    </div>

                                    <div className="details flex flex-col">
                                        <h4 className=' text-xl lg:text-[28px] font-semibold'>Vision</h4>
                                        <p className='text-[#4E4E4E] font-normal text-base lg:text-xl'>Our vision is to support with a listening ear and an empathetic heart in an integrated and relational counseling practise.</p>
                                    </div>
                                </div>

                                <div className="itemTwo flex flex-col gap-5">
                                    <div className="img relative h-[281px] lg:h-[443px] w-full">
                                        <Image src={Write} alt='yoga' fill className=' rounded-xl object-cover' />
                                    </div>
                                    <div className="details flex flex-col">
                                        <h4 className=' text-xl lg:text-[28px] font-semibold'>Mission</h4>
                                        <p className='text-[#4E4E4E] font-normal text-base lg:text-xl'>Our mission is to serve the community by bringing healing and hope to individuals, families, couples, and others seeking emotional and relational wellbeing as well as wholesome interpersonal relationships through professional counselling care.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
